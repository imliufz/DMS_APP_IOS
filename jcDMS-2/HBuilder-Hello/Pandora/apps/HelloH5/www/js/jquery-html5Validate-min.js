...
(function(a, b) {
	...
	OBJREG = {
		...
		TEL : "^1[0-9]{10}$",
		TELPHONE : "^(^0[0-9]{2}?[0-9]{8}$)|(^0[0-9]{3}?[0-9]{7,8}$)|(^1[3|4|5|6|7|8|9|][0-9]{9}$)$",
		ZIPCODE : "^\\d{6}$",
		prompt : {
			radio : "请选择一个选项。",
	...
	a.html5Validate = (function() {
		return {
			...
			isOverflow : function(h) {
				...
				var i = a(h).attr("min"), d = a(h).attr("max"), g, e, c, f = h.value;
				if (!i && !d) {
			...
			isAllpass : function(e, d) {
				...
				params = a.extend({}, g, d || {});
				if (e.size && e.size() == 1
						&& e.get(0).tagName.toLowerCase() == "form") {
					e = e.find(":input");
				} else {
				...
				var f = true, h = function(k, n, s) {
					...
					return false;
						...
						e.each(function() {
							var l = this, k = l.getAttribute("type"), j = l.tagName.toLowerCase(), m = a(this).hasProp(
									"required");
							if (k) {
								var p = k.replace(/\W+$/, "");
								if (!params.hasTypeNormally
										&& a.html5Validate.isSupport && k != p) {
									try {
										l.type = p;
									} catch (o) {
									}
							...
							if (k == "radio" && m) {
								var n = l.name ? a("input[type='radio'][name='"
										+ l.name + "']") : a(l), i = false;
								n.each(function() {
			...
			a.fn.extend({
				...
				testRemind : function(j, n) {
					...
					var c = function(t) {
						var s = "transparent", o = "dashed", p = "solid";
						var r = {}, u = {
							width : 0,
							height : 0,
							overflow : "hidden",
