var _url = httpUrlHead+"ReportServiceApp/backydwj.json?"+httpUrlEnd;
var _getFilterQueryButton = true;
var _filter = {repeatNum:true,cusSource:true,cellRate:'7:5',hasPhone:true,showTime:'DT_SCHEDULE_DATE',};
var itemData = null;
//tcCode加载状态
var finalStatus = 2;
var loadStatus = 0;
...
$(document).ready(function() {
	$("#startDate").val(getNowFormatDate(-2));
...
function getItemData(){
	...
	[
		{title:'时间类型',fiexdW:false,id:'dataType_data',to_input:'dataType',items:[
			{code:'0',value:'订单时间',isDefault:true}
		]},
